...
income_increase = st.number_input('Einkommen Erhöhung pro Jahr in %', min_value=0.0, max_value=100.0, value=1.5)
...
fig_cum.add_scatter(x=df['x'], y=df['income'], mode='lines', name='Einkommen')
